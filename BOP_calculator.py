...
def load_drivers( file_path = 'C:\\Users\\Dani\\Desktop\\RAJTVONAL_LEAGUE\\input.csv' ):
    drivers = []
    rows_done = 0
...
def save_bops(results, file_path = 'C:\\Users\\Dani\\Desktop\\RAJTVONAL_LEAGUE\\BOPs.txt'):
